...
local media_prev = create_media_button("󰼨", beautiful.xforeground, media_prev_command, false)
local media_next = create_media_button("󰼧", beautiful.xforeground, media_next_command, false)
